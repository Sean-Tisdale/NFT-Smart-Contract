...
task("mint", "Mints from the NFT contract")
  ...
  .setAction(async function (taskArguments: { address: any }, hre: any) {
...
task(
  ...
  .setAction(async function (taskArguments: { baseUrl: any }, hre: any) {
    const contract = await getContract("NFT", hre);
...
task("token-uri", "Fetches the token metadata for the given token ID")
  ...
  .setAction(async function (taskArguments: { tokenId: any }, hre: any) {
    const contract = await getContract("NFT", hre);
